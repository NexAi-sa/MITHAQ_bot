...
9. IMPORTANT CONTEXT: The current focus is "Wedding Season" (post-Ramadan spring/summer). Gear your concepts strictly towards summer engagements, family gatherings, and typical daily routines.
10. ABSOLUTELY FORBIDDEN: Do NOT write about Ramadan, fasting, iftar, suhoor, taraweeh, or any Ramadan-related themes — Ramadan has ended. We are now in Wedding Season.
...
- STRICT RULE: Ensure the context is focused purely on Wedding Season and upcoming engagements.
...
async function generateImage(tweetText) {
    ...
    // Abstract, faceless, minimalist prompt to respect privacy/Mithaq brand
    const prompt = `A minimalist, modern, and metaphoric flat vector illustration representing the following concept about finding the right spouse. IMPORTANT: DO NOT include any real human faces, text, words, or letters in the image. Keep it abstract, high quality, highly aesthetic, elegant, and suitable for a premium marriage platform in Saudi Arabia. Colors should be calm, warm, and premium. Concept context: ${tweetText.substring(0, 400)}`;
